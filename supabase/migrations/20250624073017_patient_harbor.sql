/*
  ...
  1. New Tables
    ...
    - `order_addresses` - Stores shipping and billing addresses for orders
    - `payments` - Stores payment information for orders
    - `cart_items` - Stores items in user's shopping cart
    - `wishlist` - Stores user's wishlist items
    - `recently_viewed` - Tracks products recently viewed by users
