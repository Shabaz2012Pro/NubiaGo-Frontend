...
-- Drop existing policy if it exists and create policy for order_items
...
-- Drop existing policies if they exist and create policies for cart_items
DROP POLICY IF EXISTS "Users can select their own cart items" ON cart_items;
...
-- Drop existing policies if they exist and create policies for wishlist
...
-- Drop existing policies if they exist and create policies for recently_viewed
DROP POLICY IF EXISTS "Users can select their own recently viewed items" ON recently_viewed;
...
DROP POLICY IF EXISTS "Users can insert their own recently viewed items" ON recently_viewed;
...
DROP POLICY IF EXISTS "Users can update their own recently viewed items" ON recently_viewed;
...
DROP POLICY IF EXISTS "Users can delete their own recently viewed items" ON recently_viewed;
...
-- Drop existing policies if they exist and create policies for reviews
