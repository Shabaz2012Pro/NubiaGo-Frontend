/*
  # Create e-commerce tables and policies
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE tablename = 'order_items' AND policyname = 'Users can select their own order items'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'cart_items' AND policyname = 'Users can select their own cart items'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'wishlist' AND policyname = 'Users can view their own wishlist'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'wishlist' AND policyname = 'Users can insert into their own wishlist'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'wishlist' AND policyname = 'Users can delete from their own wishlist'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'recently_viewed' AND policyname = 'Users can select their own recently viewed items'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'recently_viewed' AND policyname = 'Users can insert their own recently viewed items'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'recently_viewed' AND policyname = 'Users can update their own recently viewed items'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'recently_viewed' AND policyname = 'Users can delete their own recently viewed items'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'reviews' AND policyname = 'Users can select their own reviews'
  ) THEN
